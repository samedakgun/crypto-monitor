...
function TimeScale({ klines, width, height = 30, timeframe, timezone = 'local' }) {
    ...
    return (_jsx("canvas", { ref: canvasRef, className: "time-scale-canvas", style: {
            width: `${width}px`,
            height: `${height}px`,
            position: 'absolute',
            bottom: 0,
 ...
 * Zaman etiketlerini çiz
 */
function drawTimeLabels(ctx, klines, width, height, timeframe, timezone) {
 ...
 */
function formatTimeLabel(timestamp, timeframe, timezone) {
